...
while (i < slider.find(".sim-slider-slide").length) {
    i++;
        ...
        if(i==current_slide){
            background_color = 'background-color:'+controls_hover_color+';';
        }
        else
        {
            background_color = 'background-color:'+controls_color+';';
        };
...
//$(".sim-slider-current-inner-tab").on("click",function(){});
    //var a=$(this).css('background-color',controls_hover_color);
    //    $(this).css('background-color',controls_hover_color);
